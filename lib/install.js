"use strict";
var bower, clean, fs, logger, path, track, utils, wrench, _ensureBowerConfig, _install, _logForcedMessage, _logInstallErrorMessage, _moveInstalledLibs;
...
_install = function(mimosaConfig, cb) {
  ...
  return bower.commands.install(void 0, {
...
_moveInstalledLibs = function(copyConfigs) {
  var copyConfig, fileText, installedFiles, outFile, _i, _j, _len, _len1, _ref;
  installedFiles = [];
