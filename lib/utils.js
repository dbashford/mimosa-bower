"use strict";
var bower, fs, logger, path, strategy, wrench, _addResolvedPath, _cleanNames, _handlePackageJson, _isPathExcluded, _processOverridesList, _resolvePaths;
...
exports.gatherPathConfigs = function(mimosaConfig, installedNames, cb) {
  return bower.commands.list({
    ...
    var cleanedNames, copyConfigs, resolvedPaths;
