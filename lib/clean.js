...
_cleanInstalledLibs = function(copyConfigs) {
  var copyConfig, err, outFile, _i, _len, _results;
  _results = [];
    ...
    _results.push((function() {
      ...
      for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
        ...
        try {
          ...
          _results1.push(logger.info("Removed file [[ " + outFile + " ]]"));
        } catch (_error) {
          err = _error;
          _results1.push(logger.warn("Unable to clean file [[ " + outFile + " ]], was it moved from this location?"));
        }
      }
      return _results1;
    })());
...
exports.bowerClean = function(mimosaConfig) {
  ...
  return bower.commands.list({
    ...
    return utils.gatherPathConfigs(mimosaConfig, packages, function(copyConfigs) {
      ...
      return logger.success("Bower artifacts cleaned.");
    });
  });
};
