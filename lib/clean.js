"use strict";
var bower, cleanTempDir, fs, logger, path, track, utils, wrench, _, _cleanCache, _cleanEmptyDirs, _cleanFilesViaBower, _cleanFilesViaTrackingInfo, _cleanInstalledLibs, _removeDirs, _removeFile;
