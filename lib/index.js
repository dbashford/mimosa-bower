"use strict";
var bower, config, fs, logger, path, registerCommand, registration, strategy, wrench, _addResolvedPath, _bowerInstall, _clean, _ensureBowerConfig, _ensureDirectory, _handlePackageJson, _install, _isExcluded, _move, _moveInstalledLibs, _resolvePaths, _versionConflictMessage;
...
registration = function(mimosaConfig, register) {
  if (!mimosaConfig.bower.copy.clean) {
    return register(['preBuild'], 'init', _bowerInstall);
  }
};
