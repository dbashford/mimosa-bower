...
determineTransform = function(mimosaConfig, pack) {
  var strat, theTransform, _i, _len, _ref;
  theTransform = mimosaConfig.bower.copy.strategy[pack];
  if (!theTransform) {
    _ref = mimosaConfig.bower.copy.strategyRegexs;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      strat = _ref[_i];
    ...
    theTransform = theTransform != null ? theTransform : mimosaConfig.bower.copy.defaultStrategy;
  }
